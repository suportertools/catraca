...
//        }
    ...
    public RetornoJson RetornaPessoaCatraca(Integer pessoa_id, String numero_cartao) {
        ...
        if (pessoa_id != null) {
            json_webservice = EnviaAtualizacao.webservice(pessoa_id, inner.ObjectCatraca.getDepartamento(), inner.Numero);
        } else {
            json_webservice = EnviaAtualizacao.webservice(numero_cartao, inner.ObjectCatraca.getDepartamento(), inner.Numero);
        }
...
//                );
            ...
            if (inner.ObjectCatraca.getVerificacao_de_biometria()) {
                ...
                if (cc.getSocket_catraca()) {
                    ...
                    if (pessoa == null) {
                        Debugs.breakPoint("Depois " + pessoa + " ");
